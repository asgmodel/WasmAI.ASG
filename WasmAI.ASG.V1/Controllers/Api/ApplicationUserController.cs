...
namespace WasmAI.ASG.V1.Controllers.Api
{
    ...
    {
        private readonly IUseApplicationUserService _service;
        public ApplicationUserController(IMapper mapper, ILoggerFactory logger, IUseApplicationUserService bPR) : base(mapper, logger, bPR)
        {
            _service = bPR;
        }
    }
