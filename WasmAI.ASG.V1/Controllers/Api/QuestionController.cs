...
namespace WasmAI.ASG.V1.Controllers.Api
{
    ...
    [ApiController]
    public class QuestionController : BaseBPRControllerLayer<QuestionRequestDso, QuestionResponseDso, QuestionCreateVM, QuestionOutputVM, QuestionUpdateVM, QuestionInfoVM, QuestionDeleteVM, QuestionFilterVM>
    {
        private readonly IUseQuestionService _service;
