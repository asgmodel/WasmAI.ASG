...
{
    public interface IUseTechniqueService : ITechniqueService<TechniqueRequestDso, TechniqueResponseDso>, IBaseService, IBaseBPRServiceLayer<TechniqueRequestDso, TechniqueResponseDso>
    {
    }
}