...
{
    public interface IUseQuestionService : IQuestionService<QuestionRequestDso, QuestionResponseDso>, IBaseService, IBaseBPRServiceLayer<QuestionRequestDso, QuestionResponseDso>
    {
    }
}