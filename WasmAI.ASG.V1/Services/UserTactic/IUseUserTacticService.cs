...
{
    public interface IUseUserTacticService : IUserTacticService<UserTacticRequestDso, UserTacticResponseDso>, IBaseService, IBaseBPRServiceLayer<UserTacticRequestDso, UserTacticResponseDso>
    {
    }
}