...
{
    public interface IUseScenarioTypeService : IScenarioTypeService<ScenarioTypeRequestDso, ScenarioTypeResponseDso>, IBaseService, IBaseBPRServiceLayer<ScenarioTypeRequestDso, ScenarioTypeResponseDso>
    {
    }
}