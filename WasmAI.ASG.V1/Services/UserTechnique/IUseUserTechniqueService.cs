...
{
    public interface IUseUserTechniqueService : IUserTechniqueService<UserTechniqueRequestDso, UserTechniqueResponseDso>, IBaseService, IBaseBPRServiceLayer<UserTechniqueRequestDso, UserTechniqueResponseDso>
    {
    }
}