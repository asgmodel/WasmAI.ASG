...
{
    public class AnswerService : BaseBPRServiceLayer<AnswerRequestDso, AnswerResponseDso, AnswerRequestShareDto, AnswerResponseShareDto>, IUseAnswerService
    {
        private readonly IAnswerShareRepository _share;
        public AnswerService(IMapper mapper, ILoggerFactory logger, IAnswerShareRepository bpr) : base(mapper, logger, bpr)
        {
            _share = bpr;
        }
    }
