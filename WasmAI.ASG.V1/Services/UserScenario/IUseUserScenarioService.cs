...
{
    public interface IUseUserScenarioService : IUserScenarioService<UserScenarioRequestDso, UserScenarioResponseDso>, IBaseService, IBaseBPRServiceLayer<UserScenarioRequestDso, UserScenarioResponseDso>
    {
    }
}