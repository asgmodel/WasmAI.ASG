...
{
    public interface IUseSoftwareService : ISoftwareService<SoftwareRequestDso, SoftwareResponseDso>, IBaseService, IBaseBPRServiceLayer<SoftwareRequestDso, SoftwareResponseDso>
    {
    }
}