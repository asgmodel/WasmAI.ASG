...
{
    public interface IUseTacticService : ITacticService<TacticRequestDso, TacticResponseDso>, IBaseService, IBaseBPRServiceLayer<TacticRequestDso, TacticResponseDso>
    {
    }
}