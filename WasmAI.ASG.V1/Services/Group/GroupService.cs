...
{
    public class GroupService : BaseBPRServiceLayer<GroupRequestDso, GroupResponseDso, GroupRequestShareDto, GroupResponseShareDto>, IUseGroupService
    {
        private readonly IGroupShareRepository _share;
        public GroupService(IMapper mapper, ILoggerFactory logger, IGroupShareRepository bpr) : base(mapper, logger, bpr)
        {
            _share = bpr;
        }
    }
