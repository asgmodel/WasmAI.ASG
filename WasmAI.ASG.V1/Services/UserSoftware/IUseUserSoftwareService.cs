...
{
    public interface IUseUserSoftwareService : IUserSoftwareService<UserSoftwareRequestDso, UserSoftwareResponseDso>, IBaseService, IBaseBPRServiceLayer<UserSoftwareRequestDso, UserSoftwareResponseDso>
    {
    }
}