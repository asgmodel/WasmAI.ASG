...
{
    public interface IUseScenarioService : IScenarioService<ScenarioRequestDso, ScenarioResponseDso>, IBaseService, IBaseBPRServiceLayer<ScenarioRequestDso, ScenarioResponseDso>
    {
    }
}