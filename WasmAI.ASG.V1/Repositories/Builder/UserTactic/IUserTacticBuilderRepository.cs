...
{
    /// <summary>
    /// UserTactic interface property for BuilderRepository.
    /// </summary>
    public interface IUserTacticBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //
