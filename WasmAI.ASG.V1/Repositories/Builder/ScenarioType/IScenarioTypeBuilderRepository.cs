...
{
    /// <summary>
    /// ScenarioType interface property for BuilderRepository.
    /// </summary>
    public interface IScenarioTypeBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //
