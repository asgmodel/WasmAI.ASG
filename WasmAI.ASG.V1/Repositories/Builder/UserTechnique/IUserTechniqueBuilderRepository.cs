...
{
    /// <summary>
    /// UserTechnique interface property for BuilderRepository.
    /// </summary>
    public interface IUserTechniqueBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //
