...
{
    /// <summary>
    /// Scenario interface property for BuilderRepository.
    /// </summary>
    public interface IScenarioBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //
