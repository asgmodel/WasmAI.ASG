...
{
    /// <summary>
    /// Group interface property for BuilderRepository.
    /// </summary>
    public interface IGroupBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //
