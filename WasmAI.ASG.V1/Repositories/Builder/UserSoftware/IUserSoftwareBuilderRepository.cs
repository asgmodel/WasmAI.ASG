...
{
    /// <summary>
    /// UserSoftware interface property for BuilderRepository.
    /// </summary>
    public interface IUserSoftwareBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //
