...
{
    /// <summary>
    /// Technique interface property for BuilderRepository.
    /// </summary>
    public interface ITechniqueBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //
