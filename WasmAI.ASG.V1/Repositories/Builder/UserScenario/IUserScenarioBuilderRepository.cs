...
{
    /// <summary>
    /// UserScenario interface property for BuilderRepository.
    /// </summary>
    public interface IUserScenarioBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //
