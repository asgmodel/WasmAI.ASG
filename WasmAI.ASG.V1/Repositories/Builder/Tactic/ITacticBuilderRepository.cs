...
{
    /// <summary>
    /// Tactic interface property for BuilderRepository.
    /// </summary>
    public interface ITacticBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //
