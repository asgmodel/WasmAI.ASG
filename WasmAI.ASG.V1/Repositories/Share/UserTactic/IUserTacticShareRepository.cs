...
{
    /// <summary>
    /// UserTactic interface for RepositoriesRepository.
    /// </summary>
    public interface IUserTacticShareRepository : IBaseShareRepository<UserTacticRequestShareDto, UserTacticResponseShareDto> //
    , IBaseBPRShareLayer<UserTacticRequestShareDto, UserTacticResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,IUserTacticBuilderRepository<UserTacticRequestShareDto, UserTacticResponseShareDto>
    {
