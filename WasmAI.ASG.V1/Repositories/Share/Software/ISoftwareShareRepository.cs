...
{
    /// <summary>
    /// Software interface for RepositoriesRepository.
    /// </summary>
    public interface ISoftwareShareRepository : IBaseShareRepository<SoftwareRequestShareDto, SoftwareResponseShareDto> //
    , IBaseBPRShareLayer<SoftwareRequestShareDto, SoftwareResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,ISoftwareBuilderRepository<SoftwareRequestShareDto, SoftwareResponseShareDto>
    {
