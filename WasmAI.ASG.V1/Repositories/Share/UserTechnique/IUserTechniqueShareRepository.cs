...
{
    /// <summary>
    /// UserTechnique interface for RepositoriesRepository.
    /// </summary>
    public interface IUserTechniqueShareRepository : IBaseShareRepository<UserTechniqueRequestShareDto, UserTechniqueResponseShareDto> //
    , IBaseBPRShareLayer<UserTechniqueRequestShareDto, UserTechniqueResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,IUserTechniqueBuilderRepository<UserTechniqueRequestShareDto, UserTechniqueResponseShareDto>
    {
