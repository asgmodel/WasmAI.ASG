...
{
    /// <summary>
    /// Scenario interface for RepositoriesRepository.
    /// </summary>
    public interface IScenarioShareRepository : IBaseShareRepository<ScenarioRequestShareDto, ScenarioResponseShareDto> //
    , IBaseBPRShareLayer<ScenarioRequestShareDto, ScenarioResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,IScenarioBuilderRepository<ScenarioRequestShareDto, ScenarioResponseShareDto>
    {
