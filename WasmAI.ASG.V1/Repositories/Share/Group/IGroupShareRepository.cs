...
{
    /// <summary>
    /// Group interface for RepositoriesRepository.
    /// </summary>
    public interface IGroupShareRepository : IBaseShareRepository<GroupRequestShareDto, GroupResponseShareDto> //
    , IBaseBPRShareLayer<GroupRequestShareDto, GroupResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,IGroupBuilderRepository<GroupRequestShareDto, GroupResponseShareDto>
    {
