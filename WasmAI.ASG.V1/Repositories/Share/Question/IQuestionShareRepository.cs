...
{
    /// <summary>
    /// Question interface for RepositoriesRepository.
    /// </summary>
    public interface IQuestionShareRepository : IBaseShareRepository<QuestionRequestShareDto, QuestionResponseShareDto> //
    , IBaseBPRShareLayer<QuestionRequestShareDto, QuestionResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,IQuestionBuilderRepository<QuestionRequestShareDto, QuestionResponseShareDto>
    {
