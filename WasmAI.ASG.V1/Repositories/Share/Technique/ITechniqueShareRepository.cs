...
{
    /// <summary>
    /// Technique interface for RepositoriesRepository.
    /// </summary>
    public interface ITechniqueShareRepository : IBaseShareRepository<TechniqueRequestShareDto, TechniqueResponseShareDto> //
    , IBaseBPRShareLayer<TechniqueRequestShareDto, TechniqueResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,ITechniqueBuilderRepository<TechniqueRequestShareDto, TechniqueResponseShareDto>
    {
