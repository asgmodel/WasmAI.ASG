...
{
    /// <summary>
    /// UserSoftware interface for RepositoriesRepository.
    /// </summary>
    public interface IUserSoftwareShareRepository : IBaseShareRepository<UserSoftwareRequestShareDto, UserSoftwareResponseShareDto> //
    , IBaseBPRShareLayer<UserSoftwareRequestShareDto, UserSoftwareResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,IUserSoftwareBuilderRepository<UserSoftwareRequestShareDto, UserSoftwareResponseShareDto>
    {
